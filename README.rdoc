...
NOTE : These instructions were made assuming that you already have installed and running {Git}[http://git-scm.com/], {MySQL}[http://www.mysql.com/], {PHP}[http://www.php.net/], and a Web server like {Apache}[http://httpd.apache.org/].
